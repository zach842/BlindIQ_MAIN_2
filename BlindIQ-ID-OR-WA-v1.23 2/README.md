...
This package is **BlindIQ v1.23**. It adds complete available 2026–27 regulation packages for Idaho, Oregon, and Washington while retaining alphabetical 28-state selectors, the hunt-log-first experience, and all prior account, weather, community, and subscription features.
...
- Bottom-of-dashboard and Account links to the community form, with context-aware Back navigation
- Prepared feedback and support emails addressed to office@blindiq.app
- Visible v1.23 marker at the bottom of Account for deployment confirmation
